 ...
 * @author fvarelo
 */
public class ClienteGame extends javax.swing.JFrame {
    ...
    public ClienteGame(String playerName, java.io.PrintWriter out) {
        ...
        grosor.setVisible(false);
        lienzo.setVisible(false);
        lienzo1.setVisible(false);
...
// Mantener visible solo el fondo
        ...
        ImageIcon icon = new ImageIcon(getClass().getResource("/Gráfico/Cargando.GIF"));
        fondo.setIcon(icon);
    ...
    private void initComponents() {
        ...
        herramientas.add(jButton13);
        jButton13.setBounds(900, 10, 74, 23);
    ...
    public void handleMessage(String json) {
        ...
        switch (type) {
            case "START" -> {
                ...
                tools.startTimer(((Double) msg.get("duration")).intValue());
                ...
                setLayout(new BorderLayout());
                herramientas.removeAll(); // panel creado en el diseñador
                ...
                status.setRound(((Double) msg.get("round")).intValue());
                status.setDuration(((Double) msg.get("duration")).intValue());
                tools.setSecretWord((String) msg.get("value")); // muestra palabra al dibujante
